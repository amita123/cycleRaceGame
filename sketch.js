...
mainCyclist.addAnimation("SahilRunning1",mainRacerImg1);
...
function draw() {
  ...
  text("press up arrow to restart game",520, 200);
  
  
  
    path.velocityX = 0;
    mainCyclist.velocityY = 0;
    mainCyclist.addAnimation("SahilRunning2",mainRacerImg2);
...
function reset(){
  gameState = PLAY;
  gameOver.visible = false;
  mainCyclist.changeAnimation("SahilRunning1");
  redCG.destroyEach();
    pinkCG.destroyEach();
